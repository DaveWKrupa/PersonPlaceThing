...
new_obj = Thing(get_data_saved_callback_func(), get_invalid_data_callback_func())
new_obj.short_description = "Library Book"
new_obj.long_description = "Long description of a library book"
