...
class Event:
    def __init__(self, record_id=None,
        ...
        self.__event_time_span = DateTimeManager(start_date, start_time,
                                                 end_date, end_time,
    ...
    @property
    def start_date(self):
        return self.__event_time_span.start_date

    @start_date.setter
    def start_date(self, value):
        self.__event_time_span.start_date = value

    @property
    def start_time(self):
        return self.__event_time_span.start_time

    @start_time.setter
    def start_time(self, value):
        self.__event_time_span.start_time = value

    @property
    def start_date_time(self):
        return self.__event_time_span.start_date_time

    @start_date_time.setter
    def start_date_time(self, value):
        self.__event_time_span.start_date_time = value

    @property
    def end_date(self):
        return self.__event_time_span.end_date

    @end_date.setter
    def end_date(self, value):
        self.__event_time_span.end_date = value

    @property
    def end_time(self):
        return self.__event_time_span.end_time

    @end_time.setter
    def end_time(self, value):
        self.__event_time_span.end_time = value

    @property
    def end_date_time(self):
        return self.__event_time_span.end_date_time

    @end_date_time.setter
    def end_date_time(self, value):
        self.__event_time_span.end_date_time = value

    @property
    def duration_string(self):
        return self.__event_time_span.duration_string

    @property
    def duration_in_seconds(self):
        return self.__event_time_span.duration_in_seconds

    @property
    def event_time_span(self):
        return str(self.__event_time_span)

    def load(self, record_id):
        data = PersonPlaceThingDB().read(TableNamesEnum().EVENT, {}, record_id)
        if len(data) == 1:
            ...
            self.start_date = data[0][ColumnNamesEnum().START_TIME]
    ...
    def save(self):
        ...
        self.__record_id = \
            PersonPlaceThingDB().save(TableNamesEnum().EVENT,
                                      self.__record_id, data)

    def delete(self, record_id=None):
        if record_id:
            PersonPlaceThingDB().delete(TableNamesEnum().EVENT, record_id)
        else:
            PersonPlaceThingDB().delete(TableNamesEnum().EVENT, self.record_id)
        self.__init_event()
    ...
    def __init_event(self):
        ...
        self.__event_time_span = DateTimeManager()
